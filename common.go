...
type Config struct {
	...
	// Avaya Proactive Contact platform does not work with Golang's B.E.A.S.T patch,
	// this flag gives an ability to enable compatibility with old APC version;
	AvayaCompatibility bool
...
func initDefaultCipherSuites() {
	...
	var (
		...
		hasGCMAsmS390X = false // [apc-tls: couldn't be bothered to make it work, we won't use it]
